...
const TweetBox = (props) => {
  ...
  const Post = (e) => {
    ...
    if (content) {
      ...
      if (image) {
        var storageRef = storage.ref(storageUrl + image[0].name);
        ...
        storage
          ...
          .then((url) => {
            ...
            database.ref(`regusers/${id}`).update({
              posts: count + 1,
            });
        ...
        <div className="other">
          <div>
            ...
            <label htmlFor="icon-button-file">
              ...
              >
                <PhotoCamera className="Gif" />
              </IconButton>
            </label>
          </div>

          <button className="tweet_button" onClick={Post}>
            Tweet
          </button>
        </div>
      </form>
